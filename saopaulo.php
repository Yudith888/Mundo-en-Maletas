             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/saopaulo1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/saopaulo2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/saopaulo3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: <br>
                            Recogida en el Aeropuerto Internacional de Sao Paulo Guarulhos
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Visita al parque Ibirapuera, paseo por el barrio Villa Madelena <br>
                            Dia 3: <br>
                            Excursion al Jardin Botancio, visita al edificio Italia <br>
                            Dia 4: <br>
                            Visita al barrio de Pinheiros <br>
			                Dia 5: <br>

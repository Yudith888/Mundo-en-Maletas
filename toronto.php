             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/toronto1.webp" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/toronto2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/toronto3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: 
                            Recogida en el Aeropuerto Internacional Toronto Pearson
                            Llevada al hotel y descargue <br>
                            Dia 2: 
                            Visita a la torre CN, recorrido por el barrio de entretenimiento de Toronto  <br>
                            Dia 3: 
                            Excursion en barco a las cataratas del Niagara, visita al pueblo de Niagara on the Lake <br>
                            Dia 4: 
                            Visita la galeria de arte de Ontario, visita al centro de ciencias de Ontario <br>
                            Dia 5: 
                            Translado al aeropuerto, vuelo de regreso tokio

             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/Barranquilla1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/barranquilla2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/barranquilla3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p>  Dia 1: <br>
                            Recogida en el Aeropuerto Internacional Ernesto Cortissoz
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Paseo por el Malecon y el paseo por Boca de Ceniza <br>
                            Dia 3: <br>
                            Excursion en las playas de Salgar o Puerto colombia <br>
                            Dia 4: <br>

             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/Guatape1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/guatape2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/guatape3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: <br>
                            ...
                            Dia 2: <br>
                            Paseo por el colorido malecon de Guatape, excursion en bote por el embalse de Guatape  <br>
                            Dia 3: <br>
                            Excursion a la famosa Piedra del Peñol<br>
                            Dia 4: <br>

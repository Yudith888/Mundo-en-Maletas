    ...
    <form action="#" method="POST">
      <div class="row form-group">
        <span class="input-group-text bg-transparent">
          ...
          <div class="input__content">
            <div class="input__group">
              <select required>
                <option disabled selected="" class="punto">Origen</option>
      ...
      <div class="row form-group">
        <span class="input-group-text bg-transparent">
          ...
          <input id="ida" class="input-group-text bg-transparent" type="date" max="2030-12-31" step="4" required>
        </span>
      </div>
      ...
      <div class="row form-group">
        <span class="input-group-text bg-transparent">
          ...
          <input id="vuelta" class="input-group-text bg-transparent" type="date" max="2030-12-31" step="4" required>
        </span>
      </div>

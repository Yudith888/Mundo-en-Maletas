             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/Valledupar1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/valledupar2.jpeg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/valledupar3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: <br>
                            Recogida en el Aeropuerto Alfonso Lopez Pumarejo
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Visita al parque de la leyenda Vallenata, paseo por el centro historico <br>
                            Dia 3: <br>
                            Excursion al parque Nacional Natural Sierra Nevada de Santa marta, visita a cascada <br>
                            Dia 4: <br>

             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/miami1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image"  src="image/miami2.avif">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/miami3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p>Dia 1: <br>
                            Recogida en el Aeropuerto Internacional de Miami
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Paseo por Ocean Drive, South Beach <br>
                            Dia 3: <br>
                            Visita al Museo de Arte Perez, visita al Distrito de Miami Beach <br>
                            Dia 4: <br>
                            Excursion al Parque Nacional de los Everglades <br>
                            Dia 5: <br>

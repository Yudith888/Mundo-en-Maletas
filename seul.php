             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/seul1.png" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/seul2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/seul3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: 
                            Recogida en el Aeropuerto Internacional de Incheon
                            Llevada al hotel y descargue <br>
                            Dia 2: 
                            Visita al palacio Gyeongdokgung, recorrido por el Bukchon Hanok Village<br>
                            Dia 3: 
                            Visita a la torre N Seoul Tower en el Monte Namsan, visita al barrio Gangnam<br>
                            Dia 4: 
                            Crucero por el rio Han, visita al mercado de Namdaemun <br>
                            Dia 5: 

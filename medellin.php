             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/medellin1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/buena3.webp">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/medellin3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: <br>
                            Recogida en el Aeropuerto Internacional Jose Maria Cordova
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Visita al parque Lleras, paseo por el Parque Explora y el Jardin Botanico <br>
                            Dia 3: <br>
                            Recorrido por el centro historico de Medellin, visita a Pueblito Paisa <br>
                            Dia 4: <br>

             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/riodejaneiro1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/riodejaneiro2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/riodejaneiro3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: 
                            Recogida en el Aeropuerto Internacional Tom Jobim
                            Llevada al hotel y descargue <br>
                            Dia 2: 
                            Paseo por la playa de Copacabana, excursion al Parque Nacional de Tijuca  <br>
                            Dia 3: 
                            Paseo por el Pan de Azucar, subida en teleferico, visita al Jardin Botanico de Rio de Janeiro <br>
                            Dia 4: 
                            Paseo por el barrio de Santa Teresa, visita aplayas selvaticas de Grumari y Prainha <br>
                            Dia 5: 

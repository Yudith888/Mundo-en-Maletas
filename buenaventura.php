             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/buena1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image//Buenaventura2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image//Buenaventura3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    <label class="card" for="item-1" id="selector-1">
                        ...
                        <br>
                        <br>
                        <center> <h4>Costos por persona</h4>
                            <p>Incluye: <br>
                                *Transporte <br>
                                *Hospedaje <br>
                                *Alimentacion <br>
                    ...
                    <label class="card" for="item-2" id="selector-2">
                        ...
                        <br>
                        <br>
                        <center><h4>Hospedaje/Alimentacion</h4>
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <center><h4>Ruta Viajera</h4>
                        <p> Dia 1: 
                            Recogida en el Aeropuerto Internacional Alfonso Bonilla Aragon
                            Vuelo hacia el Aeropuerto Gerardo Tobar Lopez, llevada al hotel y descargue <br>
                            Dia 2:
                            Paseo por el Malecon Costero, excursion al parque Nacional Natural Uramba Bahia Malaga <br>
                            Dia 3: 
                            Excursion en lancha por el rio Dagua, Visita a la iglesia de San Buenaventura y paseo en piscinas termales de Santa Rosa <br>
                            Dia 4: 

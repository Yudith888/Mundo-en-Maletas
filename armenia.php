    ...
    <header class="men"> <!-- Cabecera de la página -->
        <nav class="navigation"> <!-- Navegación principal -->
            <ul> <!-- Lista no ordenada para los elementos del menú -->
                ...
                <div class="logo"><a href="compras.php"><img src="image/aterrizaje-unscreen.gif" alt="" width="50px" height="50px"></a></div> <!-- Icono de carrito de compras -->
        ...
        <div class="container">
            ...
            <div class="cards">
                <label class="card" for="item-1" id="selector-1">
                    <img class="slider_image" src="image/Armenia.jpg">

                </label>
                <label class="card" for="item-2" id="selector-2">
                    <img class="slider_image" src="image/habitacion-junior.jpg">
                </label>
                <label class="card" for="item-3" id="selector-3">
                    <img class="slider_image" src="image/armeniajpg.webp">
                </label>
            ...
            <div class="cards">
                ...
                <label class="card" for="item-3" id="selector-3">
                    ...
                    <center>
                        <h4>Ruta Viajera</h4>
                        <p> Dia 1: <br>
                            Recogida en el Aeropuerto Internacional el Eden
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Paseo por el Parque de la Vida, excursion al Parque Nacional Natural <br>
                            Dia 3: <br>
                            Tour por el Parque de la Cultura de Quindio, visita al parque Nacional del Cafe <br>
                            Dia 4: <br>

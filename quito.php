             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/quito1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/quito2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/quito3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <center><h4>IRuta Viajera</h4>
                        <p> Dia 1: 
                            Recogida en el Aeropuerto Internacional Mariscal Sucre de Quito
                            Llevada al hotel y descargue <br>
                            Dia 2: 
                            Visita a la plaza de la Independencia, Catedral Metropolitana <br>
                            Dia 3: 
                            Excursion al Parque Nacional Cotopaxi, visita al mercado Artesanal de Otavalo <br>
                            Dia 4: 
                            Excursion al Teleferico de Quito, Visita al Museo Nacional del Ecuador  <br>
                            Dia 5: 

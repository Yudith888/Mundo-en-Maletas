             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image//hongkong1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/hongkong2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/hongkong3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p>Dia 1: 
                            Recogida en el Aeropuerto Internacional de Hong Kong
                            Llevada al hotel y descargue <br>
                            Dia 2:
                            Paseo por bullicioso distrito de Mong Kok, paseo por el distrito Financiero Central <br>
                            Dia 3:
                            Excursion en ferry a la isla de Lantau, visita a la isla de Lamma <br>
                            Dia 4:
                            Visita al templo Man Mo en Sheung Wan, exploracion en la isla de Lantau <br>
                            Dia 5:

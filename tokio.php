             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/tokio1.webp" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/tokio2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/tokio3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: <br>
                            Recogida en el Aeropuerto Internacional de Tokio Haneda
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Visita al barrio de Shibuya, paseo en el barrio Harajuku  <br>
                            Dia 3: <br>
                            Recorrido al parque Yoyogi y al santuario Meiji <br>
                            Dia 4: <br>
                            Visita al distrito Odaiba, visita a los barrios de Akihabara y Ginza <br>
                            Dia 5: <br>

             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/buena2.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/cartagena2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/cartagena3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: <br>
                            Recogida en el Aeropuerto Internacional Rafael Nuñez de Cartagena de Indias
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Desayuno, luego visita al parque de la vida y parque sucre <br>
                            Dia 3: <br>
                            Tour a los termales de santa rosa <br>
                            Dia 4: <br>

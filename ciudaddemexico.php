             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/mexico1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image//mexico3.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/meico2.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: 
                            Recogida en el Aeropuerto Internacional de la Ciudad de Mexico
                            Llevada al hotel y descargue <br>
                            Dia 2: 
                            Visita a la plaza de la Constitucion (Zocalo), visita al palacio de bellas artes  <br>
                            Dia 3: 
                            Paseo por el barrio de Coyoacán y visita a la Casa Azul, antiguo hogar de Frida Kahlo, visita al Bosque de Chapultepec <br>
                            Dia 4: 
                            Excursion a las piramides de Teotihuacan <br>
                            Dia 5: 
                            Translado al aeropuerto, vuelo de regreso chicago

             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/vancouver1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/vancouver2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/vancouver3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: 
                            Recogida en el Aeropuerto Internacional de Vancouver
                            Llevada al hotel y descargue <br>
                            Dia 2: 
                            Paseo por el Stanley Park, visita al centro de Vancouver  <br>
                            Dia 3: 
                            Excursion al puente colgante Capilano Suspension Bridge Park, visita a Whistler pista de esqui <br>
                            Dia 4: 
                            Visita al jardin Botanico VanDusen, visita a Grouse Mountain actividad de senderismo <br>
			                Dia 5: 

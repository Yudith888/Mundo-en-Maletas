             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/Cali1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/cali2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/cali3.jpg">
                     </label>
                    ...
                    <label class="card" for="item-3" id="selector-3">
                       ...
                       <br>
                        ...
                        <p> Dia 1: <br>
                            ...
                            Dia 2: <br>
                            Visita a la Ciudad Amurallada, visita al Castillo San Felipe  <br>
                            Dia 3: <br>
                            Paseo por playa Blanca, islas del Rosario <br>
                            Dia 4: <br>

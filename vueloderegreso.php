...
<head>
    ...
    <title>Selección de Vuelos de Ida</title>
...
<div class="container"> <!-- Contenedor principal para las tarjetas de vuelos -->
    ...
    <div class="card right"> <!-- Tarjeta alineada a la derecha -->
        ...
        <a href="#" class="read" onclick="openPassengerModal()">Seleccionar</a>
    </div>

    <div class="card left"> <!-- Tarjeta alineada a la izquierda -->
        <h3>10:00 - 12:30</h3> <!-- Horario del vuelo -->
        <h4 >$100.000</h4>
    ...
    <div class="card right"> <!-- Otra tarjeta alineada a la derecha -->
        <h3>17:00 - 19:30</h3> <!-- Horario del vuelo -->
        <h4 >$80.000</h4>
    ...
    <div class="card left"> <!-- Otra tarjeta alineada a la izquierda -->
        <h3>22:00 - 01:00</h3> <!-- Horario del vuelo -->
        <h4 >$500.000</h4>
    ...
    <div class="card right"> <!-- Otra tarjeta alineada a la derecha -->
        <h3>05:30 - 08:00</h3> <!-- Horario del vuelo -->
        <h4 >$150.000</h4>
    ...
    <div class="card left"> <!-- Última tarjeta alineada a la izquierda -->
        <h3>12:30 - 15:00</h3> <!-- Horario del vuelo -->
        <h4 >$450.000</h4>
...
<div id="passengerModal" class="modal">
    <div class="modal-content">
        ...
        <form action="formularioreserva.php" method="get" onsubmit="return redirectToForm()">
...
function redirectToForm() {
    ...
    window.location.href = `formularioreserva.php?numPassengers=${numPassengers}`;
    return false;
}
</script>

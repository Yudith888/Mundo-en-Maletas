             ...
             <div class="container">
                 ...
                 <div class="cards">
                     <label class="card" for="item-1" id="selector-1">
                         <img class="slider_image" src="image/leticia1.jpg" >
                        
                     </label>
                     <label class="card" for="item-2" id="selector-2">
                         <img class="slider_image" src="image/leticia2.jpg">
                     </label>
                     <label class="card" for="item-3" id="selector-3">
                         <img class="slider_image" src="image/Leticia3.jpg">
                     </label>
                 ...
                 <div class="cards">
                    ...
                    <label class="card" for="item-3" id="selector-3">
                        ...
                        <p> Dia 1: <br>
                            Recogida en el Aeropuerto Internacional Alfredo Vaszquez Cobo
                            Llevada al hotel y descargue <br>
                            Dia 2: <br>
                            Paseo por el Malecon de Leticia, visita al Parque Nacional Natural Amacayacu <br>
                            Dia 3: <br>
                            Participacion de actividades culturales y artesanales con comunidades indigenas <br>
                            Dia 4: <br>
